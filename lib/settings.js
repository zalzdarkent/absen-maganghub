...
const FALLBACK_SETTINGS_PATH = path.join(os.tmpdir(), 'settings.json');
...
const FALLBACK_ENV_PATH = path.join(os.tmpdir(), '.env');
...
function readSettingsFile() {
    ...
    // Priority: if fallback has been written, use it (more recent). Otherwise use primary.
    const candidates = [FALLBACK_SETTINGS_PATH, PRIMARY_SETTINGS_PATH];
