...
function getLogbookReadPath() {
    ...
    // Both exist: pick newest. This handles Vercel where /tmp write is newer than bundled /var/task file.
    try {
...
function readLogbookFile() {
    ...
    // Prefer newest file (handles Vercel where /tmp write is newer than bundled /var/task file)
    existing.sort((a, b) => {
