...
async function getSettingsForDisplay() {
    ...
    const llmProvider = env.LLM_PROVIDER || settings.llmProvider || 'inoacGPT';
    const localLlmUrl = env.LOCAL_LLM_URL || settings.localLlmUrl || 'http://192.168.13.155:8080/v1';
...
async function saveSettings({ apiKey, repoPath, geminiModel, githubToken, repositories, activeRepoId, defaultRepoIds, llmProvider, localLlmUrl, localLlmModel } = {}) {
